...
for ((i=0; i <${#emb_modes[@]}; ++i))
    ...
    # --log.output_dir runs/${train_size}_emb5_dlm${delimit_modes[$i]}_32dim_minwf1_1conv3456_${nb_epoch}ep/ --labelling multiclass

    python run_network.py --data.data_dir ${test_file} \
