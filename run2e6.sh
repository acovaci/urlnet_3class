...
test_size=2000000
nb_epoch=5
train_file="/mnt/data/strong_dns_augmented/urlnet/urlnet-train-2e6.txt"
test_file="/mnt/data/strong_dns_augmented/urlnet/urlnet-test-2e6.txt"
...
for ((i=0; i <${#emb_modes[@]}; ++i))
    ...
    --log.output_dir runs/${train_size}_emb5_dlm${delimit_modes[$i]}_32dim_minwf1_1conv3456_${nb_epoch}ep/ 
    ...
    --model.emb_mode 5 --model.emb_dim 32 --test.batch_size 1048
