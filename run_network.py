...
urls, labels, original_labels = read_data(FLAGS["data.data_dir"], FLAGS["labelling"])
...
print("URLNET RESULTS")
print("++++++++++++++")
print()

print("CLASS SCORES")
print("============")
print(f"clean:\t\t{all_scores[0][0]:.2f}")
print(f"generated:\t{all_scores[0][1]:.2f}")
print(f"hijacked:\t{all_scores[0][2]:.2f}")
...
print()
print()
# save_test_result(original_labels, all_predictions, all_scores, FLAGS["log.output_dir"]) 
